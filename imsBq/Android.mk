...
$(shell cp $(LOCAL_PATH)/vendor/app/ims/lib/libimsmedia_jni.so $(TARGET_OUT)/system/lib/libimsmedia_jni.so)
$(shell cp $(LOCAL_PATH)/vendor/app/ims/lib/libimscamera_jni.so $(TARGET_OUT)/system/lib/libimscamera_jni.so)
